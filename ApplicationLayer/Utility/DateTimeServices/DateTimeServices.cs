...
namespace ApplicationLayer.Utility.DateTimeServices
{
   public static class DateTimeServices
    {
        ...
        public static string Utl_ghamary_date() {
            ...
            var result= ApplicationLayer.Utility.DateTimeServices.DateTimeServices.Utl_Date_ConvertToMilday(datetimeRes);
        ...
        public static DateData Utl_Date_DayOfWeek(string shamsyDate=null,DateTime? date=null) {
            ...
            {
                shamsyDate = ApplicationLayer.Utility.DateTimeServices.DateTimeServices.Utl_Date_shamsi_date();
            }
            if (shamsyDate == null && date != null)
            {
                shamsyDate = ApplicationLayer.Utility.DateTimeServices.DateTimeServices.Utl_Date_convertToShamsi((DateTime)date);
            }
            if (shamsyDate != null && date != null)
            {
                return dateData;
            ...
            dateData.ShamsyDateSlashless = Utl_Date_ConvertDateToSqlFormat(shamsyDate);
            return dateData;
        }
        //public static DateData Utl_Date_DayOfWeek(DateTime date)
        //{
        //    DateData dateData = new DateData();
        //    int year = 0;
        //    int month = 0;
        ...
        //    //if (shamsyDate == null)
        //    //{
        //      string  shamsyDate = ApplicationLayer.Utility.DateTimeServices.DateTimeServices.Utl_Date_convertToShamsi(date);
        //    //}
        //    if (shamsyDate.Length == 8)
        //    {
        //        year = int.Parse(shamsyDate.Substring(0, 4));
        ...
        //        }
        //    }
        //    dateData.FirstMounth = year + month + "01";
        //    dateData.LastMounth = year + month + dateData.MonthDays.ToString();
        //    if (year % 4 == 3)
        //        dateData.IsKabise = true;
        //    dateData.IsKabise = false;
        //    return dateData;
    ...
    public class DateData {
        ...
        public string ShamsyDateSlashless { get; set; }
